### CIT171 - prepare Week 03
###### 2022-05-03 Tuesday, May 3rd 2022, 9:00:50 am
---
Professor: Hernandez
...
Related: [[SCS-C01 Exam Prep - Chap. 1 - Security Fundamentals]]
[[Social Engineering - 2018 - Hadnagy.pdf]]
...
- A common tourist scam in Italy is where the scammer pretends to be a fashion designer, and as part of the scam, give you cheap clothing. Often times, this gift is not free, instead, the scammer will ask for something in return, mainly cash. Typically, the cash that's given by the victim to the scammer is worth more than the cheap clothing, leaving the victim with cheap, worthless clothing. 
	- <iframe width="560" height="315" src="https://www.youtube.com/embed/n3IX-e7s4z4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
---
...
- Some more professional social engineers will use scarcity in the form of time. A great example of this:
	- <iframe width="560" height="315" src="https://www.youtube.com/embed/xuYoMs6CLEw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
--- 
...
- A video of scam center in action - notice how the scammer imitates a government agent in trying to gain information about the victim. 
	- <iframe width="560" height="315" src="https://www.youtube.com/embed/jXRHb4sCM8c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
- ![[Authority.png]]
...
- Here is a great example of commitment and consistency in action
	- <iframe width="560" height="315" src="https://www.youtube.com/embed/Pd7x2bHVSAs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
---

### Prinicple Seven: Liking
- Often times, scammers will try to build their rapport with victims through conversation. 
- ![[liking.png]]
- to help encourage this feeling, you can look for ways to give a compliment and mirror body language and/or verbal cues to help the person feel warm and fuzzy toward you
- the hardest part is learning to be interested enough that your "liking" comes off as genuine
---
...
- the difference between influence and manipulation is that manipulation generally does not include caring about the feelings of the target. Whereas influence tends to be positive in its themes, manipulation does not stay within that boundary.
- Using manipulation within the context of social engineering doesn't provide a "learning lesson"
- ==principles of manipulation==
	...
	- punishment
	- intimidation
- many times, the subject will accept something they fear, that hurts, or that they know is bad simply because they don't see any other option. Fear and anger override the brain's ability to think rationally, which leaves only emotion for making decisions
- removing the option to think with logic, in most cases also removes the ability for there to be a teaching moment
- manipulation is a skill that should only be used when it's needed in large instiutions, government, or banks
